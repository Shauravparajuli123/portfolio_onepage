...
const Navbar = () => {
  ...
  return (
    ...
    <div className=' bg-black text-gray-100 h-[100px] max-w-[1400px] max-auto flex justify-between items-center '>
      <h1 className='text-3xl font-bold primary-color ml-4'>Shaurav Parajuli</h1>
      ...
      <div className={nav ? 'fixed h-full left-0 top-0 w-[60%] bg-[#202121] ease-in-out duration-500' : 'fixed left-[-100%]'} >
        <h1 className='text-3xl primary-color m-4' >Shaurav Parajuli</h1>
